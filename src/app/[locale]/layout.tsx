...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }): Promise<Metadata> {
  ...
  return {
    ...
    title: { default: "Infant God Wiki", template: "%s" },
    description: "Complete Infant God Wiki with gameplay information, mechanics, guides, updates, and essential resources.",
